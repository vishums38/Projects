...
.box input[type='submit']:hover {
    background-color: rgba(3, 164, 244, 0.7);
...
<?php
   ...
   // session_start();
    ...
    //$query = mysqli_query($db,"SELECT username FROM `login` WHERE username='$username' and password='$password'");
     //if (mysqli_num_rows($query) != 0)
    if($username=="admin" && $password==12345)
    {
     echo "<script language='javascript' type='text/javascript'> location.href='greenverify.php' </script>";   
      }
      else
      {
