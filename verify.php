...
@media(max-width: 720px){
    ...
    <div class="box">
        <h2>ENTER THE GREEN_ID TO VERIFICATION</h2>
        <form action="" method="POST">
            <img src="/images/verify.jpg" height="45" width="45">
            <div class="inputBox">
                <input type="text" name="gid" required="">
                <label for="">GREEN_ID</label>
            </div>
    ...
    define("DB_DATABASE", "id7339349_greenit");
     ...
     $res=mysqli_query($db,"SELECT `GREEN_ID` FROM `company` WHERE `company`.GREEN_ID=$gid");
     if(mysqli_num_rows($res)!=0)
     {
      echo "GREEN_ID is there</br>";
     }
     else
     {
      echo "entered GID is not there";
     }
     }
?>